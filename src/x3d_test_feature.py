...
with open(test_datafile, 'r') as f:
    test_path_file = f.read().splitlines() # path_file是一个list
...
test_dataset = VideoDataset(path_file=test_path_file, label_id_dic=label_id_dic, is_train=False)
# dataloader
...
np.save('/home/tione/notebook/dataset/x3d/test_features.npy', features)
print('done')