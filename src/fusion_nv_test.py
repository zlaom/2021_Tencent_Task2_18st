...
test_tf = '/home/tione/notebook/dataset/nextvlad/test_features.npy'
test_vf = '/home/tione/notebook/dataset/x3d/test_features.npy'

test_dataset = NVDataset(test_datafile, label_id_dic, test_tf, test_vf, is_train=False)
...
def evaluate(val_loader, model, epoch, name):
    ...
    pred_json = '/home/tione/notebook/dataset/json/test_nextvlad_x3d.json'
