...
checkpoint = './checkpoint/people/19_0.1794.pth'
device_id = 'cuda:0'
batch_size = 20
lr = 1e-4
max_epoch = 80
...
# mask
mask = torch.zeros(82)
mask[58:60] = 1; mask[61] = 1; mask[63] = 1; mask[65:67] = 1; mask[68] = 1; mask[72] = 1; mask[75] = 1; mask[77:80] = 1; mask[81] = 1; mask[51:53] = 1; mask[60] = 1; mask[64] = 1; mask[74] = 1; mask[80] = 1
