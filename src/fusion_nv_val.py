...
from src.models.fusion.models import NVSENet
from src.data.fusion_dataset import NVDataset 
...
train_tf = '/home/tione/notebook/dataset/nextvlad/train_features.npy'
val_tf = '/home/tione/notebook/dataset/nextvlad/val_features.npy'
...
train_dataset = NVDataset(train_datafile, label_id_dic, train_tf, train_vf, is_train=True)
val_dataset = NVDataset(val_datafile, label_id_dic, val_tf, val_vf, is_train=False)
...
def evaluate(val_loader, tokenizer, model, epoch, name):
    ...
    pred_json = '/home/tione/notebook/dataset/json/val_nextvlad_x3d.json'
...
model = NVSENet()
ckpt = './checkpoint/nextvlad_x3d.pth'
